...
sections:
  - heading: Starters & Soups
    layout: items
    items:
      - name: Stuffed Hot Banana Peppers MAX
  ...
  - heading: Between the Buns & Hand Helds
    ...
    footnote: <strong>Cheese add-on</strong> (Swiss, American, Cheddar, Provolone,
      Pepper Jack) +$1.50 &nbsp;·&nbsp; <strong>Mushrooms</strong> +$1.50
      &nbsp;·&nbsp; <strong>Onions</strong> +$1.50 &nbsp;·&nbsp;
      <strong>Bacon</strong> +$2.50
    items:
  ...
  - heading: Dinner Entrées
    layout: items
    note: Served with vegetables and choice of one side. Bread and butter available
      on request.
    footnote: <strong>Haddock upgrades:</strong> Cajun +$1.00 &nbsp;·&nbsp;
      Bruschetta +$3.00 &nbsp;·&nbsp; Spinach &amp; Provolone +$3.00
    items:
      ...
      - name: Chicken Parm
        ...
        signature: false
      - name: Spaghetti
        description: House sauce or garlic and oil. One meatball +$3.50 · Two +$6.50 ·
          Parmesan +$2.50.
        price: $17.00
        signature: false
    ...
    groups:
      - title: Side Options
        items:
          ...
          - Sweet Potato Fries <span
            style="color:var(--text-muted)">+$2.00</span>
      - title: Entrée Add-Ons
        items:
          ...
          - Haddock — Cajun +$1.00 · Bruschetta +$3.00 · Spinach &amp; Provolone
            +$3.00
---
